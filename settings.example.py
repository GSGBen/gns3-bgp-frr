...
# If you have a router that can run BGP: specify True here. asn1border1 and 2 will then
# try to peer with it via BGP. You'll also need to set up peering from your side (see
# README).
# If you don't: set this to False and asn1border1 and 2 will originate a default route,
# then set their default route to EXTERNAL_GATEWAY.
